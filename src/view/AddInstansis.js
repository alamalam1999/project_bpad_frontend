...
function AddInstansis() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://127.0.0.1:8000/api/user/insertinstansi', {
                method: 'POST',
                headers: {
        ...
        <div className="container-fluid">
            ...
            <div className='mt-3'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        <label for="exampleInputEmail1" className="form-label">Nama Instansi</label>
                        <input type="text" name='nama_instansi' value={formData.nama_instansi} onChange={handleChange} className="form-control" id="nama_asn" aria-describedby="nama_asn" />
                    </div>
