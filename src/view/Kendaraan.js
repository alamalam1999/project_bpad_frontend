...
import Listkendaraan from '../Books/ListKendaraan';
...
function Kendaraan() {
    ...
    const goToAddKendaraans = (e) => {
        e.preventDefault();
        navigate('/addkendaraan');
    };
            ...
            <div className="row">
                ...
                <div className="col-md-10">
                    ...
                    <div className='mt-3'>
                        ...
                        <button className='btn btn-primary' onClick={goToAddKendaraans}>Add Kendaraan</button>
                        <table className="table">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
                                    <th scope="col">nopol</th>
                                    <th scope="col">jenis_roda</th>
                                    <th scope="col">merk</th>
                                    <th scope="col">jenis_kendaraan</th>
                                    <th scope="col">tahun_kendaraan</th>
