...
function AddAsns() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://127.0.0.1:8000/api/user/insertasn', {
                method: 'POST',
                headers: {
        ...
        <div className="container-fluid">
            ...
            <div className='mt-3'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        <label for="exampleInputEmail1" className="form-label">Nama Asn</label>
                        <input type="text" name='nama_asn' value={formData.nama_asn} onChange={handleChange} className="form-control" id="nama_asn" aria-describedby="nama_asn" />
                    </div>
                    <div className="mb-3">
                        <label for="exampleInputPassword1" className="form-label">Nip</label>
                        <input type="text" name='nip' value={formData.nip} onChange={handleChange} className="form-control" id="nip" />
                    </div>
                    <div className="mb-3">
