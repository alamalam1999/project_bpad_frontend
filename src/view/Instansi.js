...
import ListInstansi from '../Books/ListInstansi';
            ...
            <div className="row">
                ...
                <div className="col-md-2 bg-light vh-100">
                    <nav className="navbar navbar-light flex-column align-items-start">
                        <a className="navbar-brand" href="#">Dashboard Instansi</a>
                ...
                <div className="col-md-10">
                    ...
                    <div className='mt-3'>
                        ...
                        <button className='btn btn-primary' onClick={goToAddBooks}>Add Instansi</button>
